...
var_dump(dechex(8231323232));exit();
...
//    echo 0x6e;exit('6e');
//    echo 0xEF;
//    var_dump(hexdec(0x6D));echo "<br>";
//    var_dump($ar = [0, 0x6D, 0xEF, 0xA1, 0, 0, 0, 0]);
//    exit();
//    echo $ar[1];
//    var_dump($ar);
//    exit();
...
//    exit();
    ...
    $tx->setClauses(array('to' => '9fdee3753061cc9033f8bcfb9fd81c18cc137f05', "value" => 2, 'data' => array(0)));
